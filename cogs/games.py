...
if TYPE_CHECKING:
    ...
    type FortuneWinningNumberPerTier = tuple[FortuneWinningNumberList, ...]
    type FortuneWinningPattern = tuple[int, int]
    type FortuneWinningPatternPerTier = tuple[FortuneWinningPattern, ...]
...
class Games(commands.Cog):
    ...
    SCRATCHER_LOOT : ScratcherLootTable = {
        100 : [
            ('Siero Ticket', 'item/article/s/30041.jpg')
        ],
        1000 : [
            ('Sunlight Stone', 'item/evolution/s/20014.jpg'),
            ('Gold Brick', 'item/evolution/s/20004.jpg'),
        ...
        12000 : [
            ...
            ('Excalibur (Water)', 'weapon/m/1040007600.jpg'),
            ('Excalibur (Earth)', 'weapon/m/1040007700.jpg'),
            ('Excalibur (Wind)', 'weapon/m/1040007800.jpg'),
            ('Excalibur (Light)', 'weapon/m/1040007900.jpg'),
            ('Excalibur (Dark)', 'weapon/m/1040008000.jpg'),
            ('Gae Bulg (Fire)', 'weapon/m/1040200900.jpg'),
            ('Gae Bulg (Water)', 'weapon/m/1040201000.jpg'),
            ('Gae Bulg (Earth)', 'weapon/m/1040201100.jpg'),
            ('Gae Bulg (Wind)', 'weapon/m/1040201200.jpg'),
            ('Gae Bulg (Light)', 'weapon/m/1040201300.jpg'),
            ('Gae Bulg (Dark)', 'weapon/m/1040201400.jpg'),
            ('Damascus Knife (Fire)', 'weapon/m/1040106600.jpg'),
            ('Damascus Knife (Water)', 'weapon/m/1040106700.jpg'),
            ('Damascus Knife (Earth)', 'weapon/m/1040106800.jpg'),
            ('Damascus Knife (Wind)', 'weapon/m/1040106900.jpg'),
            ('Damascus Knife (Light)', 'weapon/m/1040107000.jpg'),
            ('Damascus Knife (Dark)', 'weapon/m/1040107100.jpg'),
            ('Caduceus (Fire)', 'weapon/m/1040406900.jpg'),
            ('Caduceus (Water)', 'weapon/m/1040407000.jpg'),
            ('Caduceus (Earth)', 'weapon/m/1040407100.jpg'),
            ('Caduceus (Wind)', 'weapon/m/1040407200.jpg'),
            ('Caduceus (Light)', 'weapon/m/1040407300.jpg'),
            ('Caduceus (Dark)', 'weapon/m/1040407400.jpg'),
            ('Mjolnir (Fire)', 'weapon/m/1040304400.jpg'),
            ('Mjolnir (Water)', 'weapon/m/1040304500.jpg'),
            ('Mjolnir (Earth)', 'weapon/m/1040304600.jpg'),
            ('Mjolnir (Wind)', 'weapon/m/1040304700.jpg'),
            ('Mjolnir (Light)', 'weapon/m/1040304800.jpg'),
            ('Mjolnir (Dark)', 'weapon/m/1040304900.jpg'),
            ('Freikugel (Fire)', 'weapon/m/1040504400.jpg'),
            ('Freikugel (Water)', 'weapon/m/1040504500.jpg'),
            ('Freikugel (Earth)', 'weapon/m/1040504600.jpg'),
            ('Freikugel (Wind)', 'weapon/m/1040504700.jpg'),
            ('Freikugel (Light)', 'weapon/m/1040504800.jpg'),
            ('Freikugel (Dark)', 'weapon/m/1040504900.jpg'),
            ('Sky Piercer (Fire)', 'weapon/m/1040604200.jpg'),
            ('Sky Piercer (Water)', 'weapon/m/1040604300.jpg'),
            ('Sky Piercer (Earth)', 'weapon/m/1040604400.jpg'),
            ('Sky Piercer (Wind)', 'weapon/m/1040604500.jpg'),
            ('Sky Piercer (Light)', 'weapon/m/1040604600.jpg'),
            ('Sky Piercer (Dark)', 'weapon/m/1040604700.jpg'),
            ('Hercules (Fire)', 'weapon/m/1040703600.jpg'),
            ('Hercules (Water)', 'weapon/m/1040703700.jpg'),
            ('Hercules (Earth)', 'weapon/m/1040703800.jpg'),
            ('Hercules (Wind)', 'weapon/m/1040703900.jpg'),
            ('Hercules (Light)', 'weapon/m/1040704000.jpg'),
            ('Hercules (Dark)', 'weapon/m/1040704100.jpg'),
            ('Ullikummi (Fire)', 'weapon/m/1040803700.jpg'),
            ('Ullikummi (Water)', 'weapon/m/1040803800.jpg'),
            ('Ullikummi (Earth)', 'weapon/m/1040803900.jpg'),
            ('Ullikummi (Wind)', 'weapon/m/1040804000.jpg'),
            ('Ullikummi (Light)', 'weapon/m/1040804100.jpg'),
            ('Ullikummi (Dark)', 'weapon/m/1040804200.jpg'),
            ('Ameno Habakiri (Fire)', 'weapon/m/1040904300.jpg'),
            ('Ameno Habakiri (Water)', 'weapon/m/1040904400.jpg'),
            ('Ameno Habakiri (Earth)', 'weapon/m/1040904500.jpg'),
            ('Ameno Habakiri (Wind)', 'weapon/m/1040904600.jpg'),
            ('Ameno Habakiri (Light)', 'weapon/m/1040904700.jpg'),
            ('Ameno Habakiri (Dark)', 'weapon/m/1040904800.jpg'),
            ('Agni', 'summon/s/2040094000.jpg'),
            ('Varuna', 'summon/s/2040100000.jpg'),
            ('Titan', 'summon/s/2040084000.jpg'),
            ('Zephyrus', 'summon/s/2040098000.jpg'),
            ('Zeus', 'summon/s/2040080000.jpg'),
            ('Hades', 'summon/s/2040090000.jpg'),
            ('Shiva', 'summon/s/2040185000.jpg'),
            ('Europa', 'summon/s/2040225000.jpg'),
            ('Godsworn Alexiel', 'summon/s/2040205000.jpg'),
            ('Grimnir', 'summon/s/2040261000.jpg'),
            ('Lucifer', 'summon/s/2040056000.jpg'),
            ('Bahamut', 'summon/s/2040030000.jpg'),
            ('Michael', 'summon/s/2040306000.jpg'),
            ('Gabriel', 'summon/s/2040311000.jpg'),
            ('Uriel', 'summon/s/2040203000.jpg'),
            ('Raphael', 'summon/s/2040202000.jpg'),
            ('Metatron', 'summon/s/2040330000.jpg'),
            ('Sariel', 'summon/s/2040327000.jpg'),
            ('Belial', 'summon/s/2040347000.jpg'),
            ('Beelzebub', 'summon/s/2040408000.jpg'),
            ('Yatima', 'summon/s/2040417000.jpg'),
            ('Triple Zero', 'summon/s/2040425000.jpg'),
            ('Orologia', 'summon/s/2040433000.jpg'),
            ('Versusia', 'summon/s/2040448000.jpg')
        ],
        80000 : [
            ('Crystals x3000', 'item/normal/s/gem.jpg'),
            ('Damascus Crystal', 'item/article/s/203.jpg'),
            ('Intricacy Ring', 'item/npcaugment/s/3.jpg'),
            ('Sublimity Ring', 'item/npcaugment/s/4.jpg'),
            ('Gold Moon x2', 'item/article/s/30033.jpg'),
            ('Blazeheart Earrings', 'item/npcaugment/s/21.jpg'),
            ('Frostvault Earrings', 'item/npcaugment/s/22.jpg'),
            ('Lifebloom Earrings', 'item/npcaugment/s/23.jpg'),
            ('Stormchase Earrings', 'item/npcaugment/s/24.jpg'),
            ('Soulcleanse Earrings', 'item/npcaugment/s/25.jpg'),
            ('Darkfathom Earrings', 'item/npcaugment/s/26.jpg')
        ],
        90000 : [
            ('Gold Spellbook', 'item/evolution/s/20403.jpg'),
            ('Enigmatic Armilla', 'item/article/m/218.jpg'),
            ('Artifact Pith x10', 'item/article/m/216.jpg'),
            ('Moonlight Stone', 'item/evolution/s/20013.jpg'),
            ('Ultima Unit x3', 'item/article/s/138.jpg'),
            ('Aura Omega Anima', 'item/article/m/601.jpg'),
            ('Ira Omega Anima', 'item/article/m/603.jpg'),
            ('Mare Omega Anima', 'item/article/m/605.jpg'),
            ('Arbos Omega Anima', 'item/article/m/607.jpg'),
            ('Credo Omega Anima', 'item/article/m/609.jpg'),
            ('Ater Omega Anima', 'item/article/m/611.jpg'),
            ('Tome of Martial Secrets', 'item/article/m/614.jpg'),
            ('Tome of Esoteric Secrets', 'item/article/m/616.jpg'),
            ('Tome of Virtuosic Secrets', 'item/article/m/618.jpg'),
            ('Ultimate Memory x3', 'item/article/m/572.jpg'),
            ('Provenance Crystal x3', 'item/article/m/592.jpg'),
            ('Apocalyptic Black Feather x3', 'item/article/m/593.jpg'),
        ],
        85000 : [
            ('Lineage Ring x2', 'item/npcaugment/s/2.jpg'),
            ('Ruby Awakening Orb', 'item/npcarousal/m/1.jpg'),
            ('Sapphire Awakening Orb', 'item/npcarousal/m/2.jpg'),
            ('Citrine Awakening Orb', 'item/npcarousal/m/3.jpg'),
            ('Silver Moon x5', 'item/article/s/30032.jpg'),
            ('Bronze Moon x10', 'item/article/s/30031.jpg')
        ],
        70000: [
            ('Elixir x100', 'item/normal/s/2.jpg'),
            ('Soul Berry x300', 'item/normal/s/5.jpg')
        ]
    }
    # sum of all rates
    SCRATCHER_TOTAL : int = sum([r for r in SCRATCHER_LOOT])
    # rarity threshold of super rare items (Murgleis or rarer)
    SCRATCHER_THRESHOLD_GRAND : int = 100 + 1000 + 24000
    # rarity threshold of rare items (Crystals or rarer)
    SCRATCHER_THRESHOLD_GOOD : int = SCRATCHER_THRESHOLD_GRAND + 80000
    # Chestrush constants
    CHESTRUSH_LOOT : dict[str, int] = {
        ...
        'Certificus':105,
        'Fallen Sword':105,
        'Mirror-Blade Shard':105,
        'Galilei\'s Insight':105,
        'Purifying Thunderbolt':105,
        'Vortex of the Void':105,
        'Sacred Standard':105,
        'Bab-el-Mandeb':105,
        'Cute Ribbon':105,
        'Kerak':105,
        'Sunya':105,
        'Fist of Destruction':105,
        'Yahata\'s Naginata':105,
        'Cerastes':105,
        'World Ender':105,
        'Ouroboros Prime':105,
        'Evanescence':105,
        'Knight of Ice':105,
        'Atlantis':105,
        'Skeletal Eclipse':105,
        'Pain and Suffering':105,
        'Radiant Rinne':105,
        'Lord of Flames':105,
        'Claíomh Solais Díon':105,
        'Firestorm Scythe':105,
        'Calamitous Aquashade':105,
        'Crimson Scale':105,
        'Landslide Scepter':105,
        'Harmonia':105,
        'Eternal Signature':105,
        'Piercing Galewing':105,
        'Kaguya\'s Folding Fan':105,
        'Gospel Of Water And Sky':105,
        'Overrider':105,
        'Imperious Fury':105,
        'Pillardriver':105,
        'Diaitesia':105,
        ...
        'Swan':105,
        'Phoenix\'s Torch':105,
        'Causality Driver':105,
        'Bloodwrought Coral':105,
        'Agni':105,
        'Varuna':105,
        'Titan':105,
        'Zephyrus':105,
        ...
        '10K Crystal':100,
        '3K Crystal':400,
        'Intricacy Ring x3':400,
        'Damascus Crystal x3':400,
        'Premium 10-Part Ticket':400,
        'Intricacy Ring':500,
        'Lineage Ring x2':500,
        'Coronation Ring x3':500,
        'Gold Moon x2':500,
        'Gold Moon':800,
        'Silver Moon x5':800,
        'Bronze Moon x10':800,
        'Premium Draw Ticket':800,
        'Gold Spellbook x3':800,
        'Half Elixir x10':1000,
        'Soul Berry x10':1000,
        'Satin Feather x10':1250,
        'Zephyr Feather x10':1250,
        'Untamed Flame x10':1250,
        'Rough Stone x10':1250,
        'Fresh Water Jug x10':1250,
        'Swirling Amber x10':1250,
        'Falcon Feather x10':1250,
        'Vermilion Stone x10':1250,
        'Hollow Soul x10':1250,
        'Lacrimosa x10':1250,
        'Foreboding Clover x10':1250,
        'Blood Amber x10':1250,
        'Antique Cloth x10':1250,
        'White Dragon Scale x10':1250,
        'Champion Merit x10':1250,
        'Supreme Merit x10':1250,
        'Blue Sky Crystal x10':1250,
        'Rainbow Prism x10':1250,
        'Rubeus Centrum x10':1250,
        'Indicus Centrum x10':1250,
        'Luteus Centrum x10':1250,
        'Galbinus Centrum x10':1250,
        'Niveus Centrum x10':1250,
        'Ater Centrum x10':1250,
        'Fire Urn x10':1250,
        'Water Urn x10':1250,
        'Earth Urn x10':1250,
        'Wind Urn x10':1250,
        'Light Urn x10':1250,
        'Dark Urn x10':1250,
        'Horn of Bahamut x10':1250,
        'Primeval Horn x10':1250,
        'Legendary Merit':1250,
        'Sword Stone x50':1000,
        'Dagger Stone x50':1000,
        'Spear Stone x50':1000,
        'Axe Stone x50':1000,
        'Staff Stone x50':1000,
        'Pistol Stone x50':1000,
        'Melee Stone x50':1000,
        'Bow Stone x50':1000,
        'Harp Stone x50':1000,
        'Katana Stone x50':1000,
        'Silver Centrum x5':1000,
        'Ultima Unit x3':1000,
        'Fire Quartz x50':1000,
        'Water Quartz x50':1000,
        'Earth Quartz x50':1000,
        'Wind Quartz x50':1000,
        'Light Quartz x50':1000,
        'Dark Quartz x50':1000,
        'Shiva Omega Anima x3':1000,
        'Europa Omega Anima x3':1000,
        'Alexiel Omega Anima x3':1000,
        'Grimnir Omega Anima x3':1000,
        'Metatron Omega Anima x3':1000,
    ...
    async def single(
        ...
        legfest : int = commands.Param(
            description='0 to force 3%, 1 to force 6%, leave blank for default',
            default=-1,
            ge=-1,
            le=1
        ),
    ...
    async def scam_(
        ...
        scam_index : int = commands.Param(
            description='Which Scam gacha to use (Default: 1 for the first one)',
            default=1,
            ge=1
        )
    ) -> None:
    ...
    async def count(
        ...
        num : int = commands.Param(
            description='Number of rolls (2 ~ 600)',
            ge=2,
            le=600
        ),
        legfest : int = commands.Param(
    ...
    async def memeroll(
        ...
        rateup : str = commands.Param(
            description='Input anything to roll until a rate up SSR',
            default=""
        ),
        banner : int = commands.Param(
            description='1~3 for classics, 4 for collabs',
        ...
        await inter.response.defer()
        sim : GachaSimulator = await self.bot.gacha.simulate(
            "memerollB" if rateup != "" else "memerollA",
            banner,
            self.COLOR
        )
        await sim.generate(300, legfest)
    ...
    async def roulette(
        ...
        realist : int = commands.Param(
            description='1 to set Realist Mode (if allowed by owner)',
            default=0,
            ge=0,
            le=1
        )
    ...
    async def scratch(self : commands.SubCommand, inter : disnake.ApplicationCommandInteraction) -> None:
        ...
        # settings
        # these settings are here to set a period, during which,
        # the scratcher loot is boosted, to emulate what was done in march 2021
        fixedS : datetime = ct.replace( # beginning time of good scratcher
            year=2021,
            month=3,
            day=29,
            hour=19,
        ...
        betterScratcher : bool = False # if true, only good results possible
        # (it's set to True below if the some conditions are fulfilled)
        # settings end
    ...
    async def chestrush(self : commands.SubCommand, inter : disnake.ApplicationCommandInteraction) -> None:
        ...
        for item in self.CHESTRUSH_LOOT:
            ...
            if item == 'Premium 10-Part Ticket':
                rm = mm
    ...
    async def genLoto(self : Games) -> tuple[FortuneCardList, FortuneWinningNumberPerTier]:
        ...
        while len(cards) < 13:
            if len(cards) < 10:
                # generate unique last digit
                c : str = str(10 * random.randint(0, 99) + len(cards) % 10).zfill(3)
            else:
        ...
        # (number of digits, number of winning numbers)
        patterns : FortuneWinningPatternPerTier = ((3, 2), (2, 2), (2, 3), (1, 2))
        tier : int
        ...
        for tier, pattern in enumerate(patterns):
            ...
            for i in range(0, pattern[1]):
                while True:
                    # random + pad string
                    card : str = str(random.randint(0, pad - 1)).zfill(pattern[0])
    ...
    async def printLoto(
        self : Games,
        revealedCards : FortuneCardList,
        revealedWinning : FortuneWinningNumberPerTier,
        prize : list[int],
        total : bool = False
    ) -> tuple[str, str|None]:
        desc : list[str] = []
    ...
    async def fortune(
        self : commands.SubCommand,
        inter : disnake.ApplicationCommandInteraction,
        usercards : str = commands.Param(description='List your cards here', default="")
    ) -> None:
        ...
        await inter.edit_original_message(
            embed=self.bot.embed(
                ...
                description="The winning numbers are...",
                color=self.COLOR
            )
        )
        # generate loto
    ...
    async def poker(
        self : commands.SubCommand,
        inter : disnake.ApplicationCommandInteraction,
        max_round : int = commands.Param(description="Number of rounds to play", ge=1, le=5, default=1)
    ) -> None:
        ...
        if len(players) == 1:
            await inter.edit_original_message(
                embed=self.bot.embed(
                    title="♠️ Multiplayer Poker ♥️",
                    description="Error, at least two Players are required",
                    color=self.COLOR
                )
            )
            ...
            for p in players: # initialize
                win_tracker[p.id] = [
                    (
                        p.display_name
                        if len(p.display_name) <= 10
                        else p.display_name[:10] + "..."
                    ),
                    0
                ]
            i : int
            for i in range(0, max_round): # for loop, the game is composed of 3 rounds
                ...
                if i < max_round - 1:
                    await gview.message.delete()
            if max_round > 1:
                win_tracker = dict(sorted( # sort in reverse order
                    win_tracker.items(),
    ...
    async def blackjack(self : commands.SubCommand, inter : disnake.ApplicationCommandInteraction) -> None:
        ...
        if inter.guild is not None:
            ...
            embed : disnake.Embed = self.bot.embed(
                title="♠️ Multiplayer Blackjack ♥️",
                description=desc.format(60, 1),
                color=self.COLOR
            )
        ...
        embed = self.bot.embed(
            title="♠️ Multiplayer Blackjack ♥️",
            description="Initialization",
            footer="Game limited to 4 minutes",
            color=self.COLOR
        )
    ...
    async def tictactoe(self : commands.SubCommand, inter : disnake.ApplicationCommandInteraction) -> None:
        ...
        if len(players) == 1:
            await inter.edit_original_message(
                embed=self.bot.embed(
                    title=":x: Multiplayer Tic Tac Toe :o:",
                    description="Error, a 2nd Player is required",
                    color=self.COLOR
                )
            )
        else:
            ...
            embed = self.bot.embed(
                title=":x: Multiplayer Tic Tac Toe :o:",
                description=":x: {} :o: {}\nTurn of **{}**".format(
                    view.players[0].display_name,
                    view.players[1].display_name,
                    view.players[0].display_name
                ),
                footer="Game limited at 3 minutes",
                color=self.COLOR
            )
    ...
    async def connectfour(self : commands.SubCommand, inter : disnake.ApplicationCommandInteraction) -> None:
        ...
        if len(players) == 1:
            ...
            embed = self.bot.embed(
                title=":red_circle: Multiplayer Connect Four :yellow_circle:",
                description=":red_circle: {} :yellow_circle: {}".format(
                    players[0].display_name,
                    players[1].display_name
                ),
                footer="Game limited to 8 minutes",
                color=self.COLOR
            )
    ...
    async def rockpaperscissor(
        self : commands.SubCommand,
        inter : disnake.ApplicationCommandInteraction,
        bestof : int = commands.Param(description="How many rounds to win", ge=1, le=10, default=1)
    ) -> None:
    ...
    async def dice(
        self : commands.SubCommand,
        inter : disnake.ApplicationCommandInteraction,
        dice_string : str = commands.Param(description="Format is NdN. Minimum is 1d4, Maximum is 10d100")
    ) -> None:
        """Roll some dies"""
        try:
            await inter.response.defer()
            ...
            for i in range(n):
                ...
                if len(rolls) == n:
                    msgs.append(
                        "\n**Total**: {:}, **Average**: {:}, **Percentile**: {:.1f}%".format(
                            sum(rolls),
                            round(sum(rolls) / len(rolls)),
                            sum(rolls) * 100 / (n * d)
                        ).replace('.0%', '%')
                    )
                await inter.edit_original_message(
            ...
            await inter.edit_original_message(
                embed=self.bot.embed(
                    ...
                    description=(
                        "Invalid string `{}`\n"
                        "Format must be `NdN` (minimum is `1d6`, maximum is `10d100`)"
                    ).format(
                        dice_string
                    ),
                    color=self.COLOR
    ...
    async def coin(self : commands.SubCommand, inter : disnake.ApplicationCommandInteraction) -> None:
        ...
        await inter.edit_original_message(
            embed=self.bot.embed(
                ...
                description=(
                    ":coin: It landed on **Head**"
                    if (coin == 0)
                    else ":coin: It landed on **Tail**"
                ),
                color=self.COLOR
            )
        )
    ...
    async def quota(self : commands.SubCommand, inter : disnake.ApplicationCommandInteraction) -> None:
        ...
        if c < 4:
            ...
            if c <= 3:
                await inter.edit_original_message(
                    embed=self.bot.embed(
                        title="{} {}'s daily quota".format(
                            self.bot.emote.get('gw'),
                            inter.author.display_name
                        ),
                        description=(
                            "You got the **Eternal Battlefield Pass** 🤖\n"
                            "Congratulations!!!\n"
                            "GW will now last forever!"
                        ),
                ...
                await inter.edit_original_message(
                    embed=self.bot.embed(
                        ...
                        description=(
                            "You got a **Hard Carry Pass** 🤖\n"
                            "Congratulations!!!\n"
                            "Call your boss and take a day off now!"
                        ),
                        footer="Full Auto and Botting are forbidden",
                        thumbnail=inter.author.display_avatar,
                        color=self.COLOR
                    )
                )
                ...
                await inter.edit_original_message(
                    embed=self.bot.embed(
                        ...
                        description=(
                            "You got a **Carry Pass** 😈\n"
                            "Don't stop grinding, continue until your Crew gets the max rewards!"
                        ),
                        thumbnail=inter.author.display_avatar,
                        color=self.COLOR
                    )
                ...
                await inter.edit_original_message(
                    embed=self.bot.embed(
                        ...
                        description=(
                            "You got a **Relief Ace Pass** 😈\n"
                            "Prepare to relieve carries of their 'stress' after the day!!!"
                        ),
                        footer="wuv wuv",
                        thumbnail=inter.author.display_avatar,
                        color=self.COLOR
                ...
                await inter.edit_original_message(
                    embed=self.bot.embed(
                        ...
                        description="You got a **Free Leech Pass** 👍\nCongratulations!!!",
                        thumbnail=inter.author.display_avatar,
                        color=self.COLOR
                    )
                )
    ...
    async def character(self : commands.SubCommand, inter : disnake.ApplicationCommandInteraction) -> None:
        ...
        await inter.response.defer()
        # create seed based on user id + day
        seed : int = (inter.author.id + int(self.bot.util.UTC().timestamp()) // 86400)
    ...
    async def choice(
        self : commands.SubCommand,
        inter : disnake.ApplicationCommandInteraction,
        choices : str = commands.Param(description="Format is Choice 1;Choice 2;...;Choice N")
    ) -> None:
        ...
        try:
            ...
            await inter.edit_original_message(
                embed=self.bot.embed(
                    title="Error",
                    description="Give me a list of something to choose from, separated by `;`",
                    color=self.COLOR
                )
            )
        await self.bot.channel.clean(inter, 45)
    ...
    async def when(
        ...
        await inter.response.defer()
        if question.lower().startswith("when ") and len(question) > 5:
            question = question[5:]
        await inter.edit_original_message(
            embed=self.bot.embed(
                author={
    ...
    async def uwu(
        ...
        if len(msg) == 0 or len(msg) >= 3800:
            await inter.edit_original_message(
                embed=self.bot.embed(
                    title="Error",
                    description="This message can't be converted",
                    color=self.COLOR
                )
            )
        else:
